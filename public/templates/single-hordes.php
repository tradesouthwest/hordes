...
<div class="hrdsclearfix"></div>
    <div id="content" class="hordes-row">
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?> 
            ...
            <div class="entry hordes-single-entry">
                ...
                <ul class="hrds-list-inline">
                    ...
                    <span class="hrds-tags"> | <?php 
                    printf( hordes_get_terms_tag_list() ); //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                    ?></span>
                    </li>
                </ul>
            ...
            <div class="comments">
                ...
                comments_popup_link(
                $dsp . __( 'Leave a comment', "hordes"),
                $dsp . __( '1 Comment', "hordes"),
                $dsp . __( '% Comments', "hordes")); ?></li>
                </ul>
                <?php 
                } ?>
        ...
        elseif( is_tax() ) :                 
            ...
            $taxonomy   = get_queried_object();  // phpcs:ignore WordPress.WP.GlobalVariablesOverride.Prohibited
            ...
            if( $count ) { 
                ...
                <h2><?php echo esc_html( $taxonomy->name ); ?></h2>
                    ...
                    <?php echo esc_html( get_the_title() ); ?></a> <small><em><?php esc_html_e( 'link > ', 'hordes' ); ?></em></small> 
                    <?php 
